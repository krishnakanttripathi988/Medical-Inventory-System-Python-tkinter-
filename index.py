...
def openHome():
    ...
    LabelImage = (Image.open(r"Krishna.png"))
...
def Inventory():
    ...
    inventoryIMG=(Image.open(r"inventoryIMG.png"))
    ...
    def action():
        ...
        with open('inventory.csv', 'a', newline = '') as f:
            ...
            if os.stat('inventory.csv').st_size == 0:        #if file is not empty than header write else not
